            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  wrapTextRow('Danh mục', product.category),
                  wrapTextRow('Đặc điểm', product.productProperties),
                  wrapTextRow('Canh tác', product.cultivationInfo),
                  wrapTextRow('Xuất xứ', product.origin),
                  wrapTextRow('Thông tin', product.info),
                  wrapTextRow('Gía tiền', product.price?.toString()),
                  wrapTextRow('Đơn vị', product.quantityUnit),
                  wrapTextRow('Số lượng', product.quantity?.toString()),
